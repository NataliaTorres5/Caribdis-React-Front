        ...
        <div className="container-footer ">
                ...
                <li className=".social-list ">
                  <a href=".com">
                    <svg
                      ...
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      className="socialh bi bi-instagram"
                    >
                ...
                <li>
                  <a href=".com">
                    <svg
                      ...
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      className="socialh bi bi-facebook"
                    >
                ...
                <li>
                  <a href=".com">
                    <svg
                      ...
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      className="socialh bi bi-twitter-x"
                    >
          ...
          <div className="footer-link-box">
            <div className="infobox">
              <h3 className="footerh3">Contáctanos</h3>
              <br className="br" />
              ...
              <div className="infocontent">
                ...
                <a href="mailto:caridbdis@help.com">
                  <span className="footer-link-text">caribdis@help.com</span>
                </a>
              </div>
            </div>
            <div className="infobox">
              ...
              <div className="infocontent">
                <a href=".com">
                  <span classNames="footer-link-text">Nuevos productos</span>
                </a>
              </div>
            </div>
            <div className="infobox">
      ...
      <div className="footer-bottom">
        <div className="container">
          <p className="copyright">
            © 2024{" "}
            <a href="com" className="copyright-link">
              Natalia M Torres M
            </a>
